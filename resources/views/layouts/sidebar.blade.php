<aside class="page-sidebar">
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
            <img src="{{ asset('dist/img/logo.png') }}" alt="SmartAdmin WebApp" aria-roledescription="logo">
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <div class="info-card">
            <img src="{{ asset('dist/img/demo/avatars/avatar-admin.png') }}" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
            ...
            <img src="{{ asset('dist/img/card-backgrounds/cover-2-lg.png') }}" class="cover" alt="cover">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li>
                <a href="#" title="Theme Settings" data-filter-tags="theme settings">
                    <i class="fal fa-cog"></i>
                    <span class="nav-link-text" data-i18n="nav.theme_settings">Data Master</span>
                </a>
                <ul>
                    <li>
                        <a href="/barang/index" title="How it works" data-filter-tags="theme settings how it works">
